<div class="centrado">
      ...
      <div class="container-fluid">
          ...
          <div class="row altura">
            <div class="col centrado bordes altura4 minimo-texto" style="background-image: url('/assets/img/fondoBueno.png');">
              ...
              <p class="fijar_texto">
                ...
                Nuestros viñedos disfrutan de las particularidades que brinda esta tierra para cultivar uvas de la más alta calidad.
                  ...
                  <!-- <div class="col bordes" style="background-image: url('/assets/img/viñedo2.png');"> -->
                  <div class="col bordes centrado" style="background-image: url('/assets/img/fondoBueno.png');" >
                    <img src="/assets/img/viñedo2.png" class="img-fluid minimo-imagen" alt="foto vinos">
                  </div>
          </div>

          <div class="row altura">
            <div class="col bordes centrado" style="background-image: url('/assets/img/fondoBueno.png');">
            <img src="/assets/img/uvas.png" class="img-fluid minimo-imagen" alt="foto vinos">
            </div>
            <div class="col centrado bordes minimo-texto" style="background-image: url('/assets/img/fondoBueno.png');">
          ...
          <div class="row altura ">
            ...
            <div class="col bordes centrado " style="background-image: url('/assets/img/fondoBueno.png');">
            <img src="/assets/img/vinos4.png" class="img-fluid minimo-imagen" alt="foto vinos">
            </div>
          </div>
